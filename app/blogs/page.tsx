      ...
      {/* Heading */}
        ...
        <div className="mt-4 flex justify-between gap-6">
          {blogLinks.map(({label, href}) => (
            <Link href={href} target="_blank" className="flex-1 bg-secondaryLight dark:bg-secondaryDark text-lg font-semibold rounded-md text-center py-2 px-8">{label}</Link>
          ))}
        </div>
        {/* Search area */}
        {/* Blog tiles */}
